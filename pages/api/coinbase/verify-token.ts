...
export default async function handler(
  ...
  try {
    ...
    const baseVerifyToken: string | undefined =
      verificationData?.token || verificationData?.data?.token;
    ...
    try {
      ...
      const existingByToken = await prisma.coinbaseVerifiedUser.findUnique({
      ...
      const result = await prisma.coinbaseVerifiedUser.upsert({
